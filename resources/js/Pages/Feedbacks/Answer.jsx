...
class Answer extends Component {
    ...
    handleSubmit(event) {
        ...
        axios.put("/api/feedbacks/"+this.state.id, {
    ...
    componentDidMount() {
        ...
        axios
            .get("/api/feedbacks/"+this.props.params.id)
            .then(response => {
                this.setState({id: response.data.data.id});
                this.setState({answer: response.data.data.answer});
            })
            .finally(() => this.setState({ isLoading: false }));
...
export default withParams(withNavigation(Answer));
